...
export type StepAction = 'click' | 'dblclick' | 'input' | 'change' | 'keydown' | 'navigate' | 'select' | 'check' | 'uncheck' | 'hover' | 'scroll' | 'wait' | 'assert' | 'screenshot';
...
export type SelectorStrategy = 'data-testid' | 'id' | 'aria-label' | 'name' | 'role' | 'text' | 'css' | 'xpath' | 'relative-xpath' | 'complex-xpath' | 'getByRole' | 'getByText' | 'getByTestId';
export interface SelectorCandidate {
    strategy: SelectorStrategy;
    value: string;
    confidence: number;
}
export type RunnerStatus = 'idle' | 'running' | 'paused' | 'stopped' | 'completed' | 'error';
...
export type PluginHook = 'beforeRecord' | 'afterRecord' | 'beforeRun' | 'afterRun' | 'beforeStep' | 'afterStep' | 'onExport';
